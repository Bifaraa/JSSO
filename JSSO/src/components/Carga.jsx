...
export function Carga() {
  ...
  /* Apenas se carga el componente comienza a settear el estado de la barra de carga (barCarga)
  tomando un número aleatorio entre 1 y 0 y va avanzando. Usa el setInverval para repetir el setBarcarga cada .500s 
  cuando el porcentaje sea 100 se usa navigate para ir a login */
